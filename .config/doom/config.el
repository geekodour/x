...
(defun ellama-make-flash-cards ()
  ...
  (let ((text (if (region-active-p)
    ...
    (ellama-chat (concat (format "Text:\n%s\n" text)
                         ...
                         "- Second line: Back of the card (answer), keep the answer short and precise. If the answer is longer than one line, prefer breaking the answer into bullet points\n\n"
                         "Example:\n"
                         "* What is an apple?\n"
                         "A fruit"
                         ))))
